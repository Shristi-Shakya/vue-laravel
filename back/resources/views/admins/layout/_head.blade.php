<html>
    ...
    <title>{{ $client->getApplicationName() }} @yield('title')</title>
    ...
    <link rel="icon" href="{{ URL('public/uploads/web/favicon.ico') }}">
    <!-- Bootstrap 3.3.5 -->
    ...
    <!-- jvectormap -->
    <link rel="stylesheet" href="{{ URL('public/backend/plugins/jvectormap/jquery-jvectormap-1.2.2.css') }}">
